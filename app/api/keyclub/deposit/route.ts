...
export async function POST(request: NextRequest) {
  try {
    ...
    const pixPayload =
      ...
      depositData.qr_code ||
      `00020126580014BR.GOV.BCB.PIX0136${depositPayload.payer.document}0214Meta Desbloqueio5204000053039865802BR5925${depositPayload.payer.name.toUpperCase()}6009SAO PAULO62070503***6304${Math.random().toString().substr(2, 4)}`
